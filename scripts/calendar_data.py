...
#     cal.add("prodid", default_values["prodid"])
#     cal.add("version", "2.0")
...
# state_path = "./data/output/state.json"
# state_path = "./data/output/state_extracted_updated.json"
state_path = "./data/output/state_run2.json"
calendar_path = "./data/output/calendar_run2.ics"
...
calendar = create_calendar(state["extracted_data"])

print("writing calendar data...")
# print(str(calendar))
with open(calendar_path, "wb") as wfile:
    wfile.write(calendar.to_ical())
